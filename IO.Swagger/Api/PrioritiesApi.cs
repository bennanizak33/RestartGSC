...
namespace IO.Swagger.Api
{
    ...
    public interface IPrioritiesApi : IApiAccessor
    {
        ...
        List<Restaurant> PrioritiesGetPriorities ();
    ...
    public partial class PrioritiesApi : IPrioritiesApi
    {
        ...
        /// <returns></returns>
        public PrioritiesApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;Restaurant&gt;</returns>
        public List<Restaurant> PrioritiesGetPriorities ()
        {
             ApiResponse<List<Restaurant>> localVarResponse = PrioritiesGetPrioritiesWithHttpInfo();
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Restaurant&gt;</returns>
        public ApiResponse< List<Restaurant> > PrioritiesGetPrioritiesWithHttpInfo ()
        {
